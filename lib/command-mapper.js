...
class CommandMapper {
    constructor() {
        ...
        this.commandMap = {
            ...
            'open': () => ({ command: 'turnOn', parameter: '1', commandType: 'command' }),
            'close': () => ({ command: 'turnOn', parameter: '2', commandType: 'command' }),
            'pause': () => ({ command: 'turnOff', parameter: 'all', commandType: 'command' }),
